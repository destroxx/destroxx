...
CONTRAST = 1.0
BRIGHTNESS = 1.0
GAMMA = 0.65          # <1 brightens mids -> face lands in sparser chars
SHARPEN = False
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">destroxx@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'destroxx@github:~$ whoami <tspan fill="{INK}">Tanmay Singh</tspan></text>')
