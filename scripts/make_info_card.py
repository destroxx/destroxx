...
# ===========================================================================
HOST = "destroxx"   # shown as  destroxx@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Solution Engineer"),
    ("kv", "Goal", "Aspiring Cloud & DevOps Engineer"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C++, Python, JavaScript"),
    ("kv", "Backend", "Node.js, REST APIs, SQL"),
    ("kv", "Cloud", "AWS, Docker, CI/CD"),
    ("kv", "Tools", "Git, Linux, Postman"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Backend engineer at heart -- reliable, performant systems"),
    ("bul", "Leveling up cloud & DevOps skills through hands-on projects"),
]
